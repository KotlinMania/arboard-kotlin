...
This file is the quick-reference operating contract for arboard-kotlin. The longer
...
arboard-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`arboard`](https://crates.io/crates/arboard). Upstream Rust is the behavioral oracle while the
